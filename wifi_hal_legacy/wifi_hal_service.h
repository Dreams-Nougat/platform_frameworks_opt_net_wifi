...
class WifiHalService : public IWifi {
 public:
  ...
  Return<void> registerEventCallback(const sp<IWifiEventCallback>& callback) override;

  Return<bool> isStarted() override;
  Return<void> start(uint32_t cmd_id) override;
  Return<void> stop(uint32_t cmd_id) override;
