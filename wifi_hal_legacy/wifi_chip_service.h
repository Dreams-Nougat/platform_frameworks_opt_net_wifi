...
#ifndef WIFI_HAL_LEGACY_WIFI_CHIP_SERVICE_H_
#define WIFI_HAL_LEGACY_WIFI_CHIP_SERVICE_H_
...
class WifiChipService : public IWifiChip {
 public:
  WifiChipService(
  ...
  Return<void> registerEventCallback(const sp<IWifiChipEventCallback>& callback) override;
  ...
  Return<void> pollChipInfo() override;

 private:
  WifiHalService* hal_service_;
...
#endif  // WIFI_HAL_LEGACY_WIFI_CHIP_SERVICE_H_
