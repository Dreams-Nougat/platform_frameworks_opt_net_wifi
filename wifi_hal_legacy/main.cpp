...
int main(int /*argc*/, char** argv) {
  ...
  android::sp<android::hardware::wifi::WifiHalService> service =
      new android::hardware::wifi::WifiHalService(looper);
  hidl_version version = android::hardware::make_hidl_version(1,0);
  CHECK_EQ(service->registerAsService(android::String16("wifi"), version),
