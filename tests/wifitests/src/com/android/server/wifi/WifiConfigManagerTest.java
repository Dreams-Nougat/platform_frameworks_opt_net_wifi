...
// createDHCPIpConfigurationWithStaticProxy
// createDHCPIpConfigurationWithNoProxy
    /**
    ...
    /**
     * Verifies that updating a network (with no proxy) and adding a PAC or STATIC proxy fails
     ...
     * {@link DeviceAdminInfo.USES_POLICY_DEVICE_OWNER} are successful.
     */
    @Test
    ...
    /**
     * Verifies that updating a network that has a proxy without changing its proxy is successful
     * even without proxy specific permissions.
     */
    @Test
    public void testUpdateNetworkUnchangedProxy() {
        ...
        NetworkUpdateResult result = createAddVerifyNetworkWithProxySettingsAndPermissions(
                        ...
                        true, // assertSuccess
                        WifiConfiguration.INVALID_NETWORK_ID); // Update networkID
        // Update the network while using the same ipConf
        createAddVerifyNetworkWithProxySettingsAndPermissions(
                        false, // asSystem
                        false, // withProfileOwnerPolicy
                        false, // withDeviceOwnerPolicy
    ...
    public void testUpdateNetworkDifferentProxy() {
        // Create two different proxy configurations of the same type
