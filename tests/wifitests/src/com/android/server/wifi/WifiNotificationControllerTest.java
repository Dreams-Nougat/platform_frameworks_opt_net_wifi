...
public class WifiNotificationControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mWifiNotificationHelper.createMainNotification(any(WifiConfiguration.class)))
                .thenReturn(mNotification);
        when(mWifiNotificationHelper.createConnectingNotification(any(WifiConfiguration.class)))
                .thenReturn(mNotification);
        when(mWifiNotificationHelper.createConnectedNotification(any(WifiConfiguration.class)))
                .thenReturn(mNotification);

        mTestLooper = new TestLooper();
        mWifiNotificationController = new WifiNotificationController(
                mContext, mTestLooper.getLooper(), mScoreManager,
    ...
    public void verifyNotificationsFlowOnConnectToNetwork() {
        ...
        mTestLooper.moveTimeForward(100000);
