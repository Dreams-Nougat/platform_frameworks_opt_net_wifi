...
/**
 * Class allowing tests for the WifiServiceImpl object.
 *
 * This class allows portions of the WifiServiceImpl constructor implementation to be overridden.
 */
class TestWifiServiceImpl extends WifiServiceImpl {
    ...
    @Mock WifiWakeupController mWifiWakeupController;

    TestLooper mTestLooper;

    TestWifiServiceImpl(Context context) {
        super(context);
    }
    ...
    WifiInjector createWifiInjector(Context context) {
        ...
        when(mWifiInjector.getWifiWakeupController()).thenReturn(mWifiWakeupController);
