...
public class ExternalScoreEvaluatorTest {
    ...
    public void setUp() throws Exception {
        ...
        mExternalScoreEvaluator.initialize(mContext, mWifiConfigManager, mWifiInfo, mClock, null);
    }
    ...
    public void chooseEphemeralNetworkBecauseOfNoSavedNetwork() {
        ...
        WifiConfiguration candidate = mExternalScoreEvaluator.evaluateNetworks(scanDetails,
                null, null, false, true, mScoreCache, null);
    ...
    public void noEphemeralNetworkWhenUntrustedNetworksNotAllowed() {
        ...
        WifiConfiguration candidate = mExternalScoreEvaluator.evaluateNetworks(scanDetails,
                null, null, false, false, mScoreCache, null);
    ...
    /**
     * Choose externaly scored saved network.
     */
    @Test
    ...
    /**
     * Choose externaly scored saved network with higher score.
     */
    @Test
    ...
    /**
     * Prefer externaly scored saved network over untrusted network when they have
     * the same score.
     */
    @Test
