...
public class ExternalScoreEvaluatorTest {
    ...
    public void chooseEphemeralNetworkBecauseOfNoSavedNetwork() {
        ...
        int[] freqs = {2470, 2437};
        Capabilities[] caps = {mSecureNetworkCapabilities, mOpenNetworkCapabilities};
    ...
    public void chooseHigherScoredEphemeralNetwork() {
        ...
        String[] bssids = {"6c:f3:7f:ae:8c:f3", "6c:f3:7f:ae:8c:f4"};
        int[] freqs = {2470, 2437};
        Capabilities[] caps = {mOpenNetworkCapabilities, mOpenNetworkCapabilities};
    ...
    public void chooseUntrustedNetworkWithHigherScoreThanExternallyScoredSavedNetwork() {
        ...
        int[] savedFreqs = {2470};
        Capabilities[] savedCaps = {mSecureNetworkCapabilities};
        ...
        Capabilities[] ephemeralCaps = {mOpenNetworkCapabilities};
