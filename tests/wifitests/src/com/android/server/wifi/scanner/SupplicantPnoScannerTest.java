...
public class SupplicantPnoScannerTest {
    ...
    public void forceRestartHwDisconnectedPnoScanWhenSettingsChange() {
        ...
        pnoSettings.networkList[pnoSettings.networkList.length - 1] =
                createDummyPnoNetwork("ssid_pno_new", 6);
        startSuccessfulPnoScan(null, pnoSettings, null, pnoEventHandler);
    ...
    private WifiNative.PnoNetwork createDummyPnoNetwork(String ssid, int priority) {
    ...
    private WifiNative.PnoSettings createDummyPnoSettings(boolean isConnected) {
        ...
        pnoSettings.networkList[0] = createDummyPnoNetwork("ssid_pno_1", 1);
        pnoSettings.networkList[1] = createDummyPnoNetwork("ssid_pno_2", 2);
        return pnoSettings;
    }
