...
public class HSWanMetricsElementTest {
    ...
    private static final long TEST_DOWNLINK_SPEED = 0xFFFFFFFFL;
    private static final long TEST_UPLINK_SPEED = 0xFFFFFFFFL;
    private static final int TEST_DOWNLINK_LOAD = 0xFF;
    private static final int TEST_UPLINK_LOAD = 0xFF;
    private static final int TEST_LMD = 0xFFFF;
