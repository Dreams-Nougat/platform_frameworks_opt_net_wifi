...
import com.android.server.wifi.hotspot2.DomainMatcher.Match;
...
public class DomainMatcherTest {
     ...
     */
    private static final Map<String, Match> TEST_DOMAIN_MAP = new HashMap<>();
    static {
        TEST_DOMAIN_MAP.put("", Match.None);
        TEST_DOMAIN_MAP.put("com", Match.None);
        TEST_DOMAIN_MAP.put("test.com", Match.None);
        TEST_DOMAIN_MAP.put("google.com", Match.Primary);
        TEST_DOMAIN_MAP.put("test.google.com", Match.Primary);
        TEST_DOMAIN_MAP.put("android.com", Match.Secondary);
        TEST_DOMAIN_MAP.put("test.android.com", Match.Secondary);
        TEST_DOMAIN_MAP.put("testing.test.com", Match.Secondary);
        TEST_DOMAIN_MAP.put("adbcd.testing.test.com", Match.Secondary);
    }
