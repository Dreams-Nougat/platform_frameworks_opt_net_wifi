...
public class I18NameTest {
    ...
    /**
     * Verify the expectations when parsing an empty buffer.
     *
     * @throws Exception
     */
    ...
    /**
     * Verify the expectations when the length field is set to more than the actual buffer size.
     *
     * @throws Exception
     */
    @Test(expected = BufferUnderflowException.class)
    ...
    /**
     * Verify the expectations when the length field is set to less than the minimum.
     *
     * @throws Exception
     */
    ...
    /**
     * Verify the expectations when parsing a buffer containing the predefined test data.
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Verify the expectations when parsing a buffer containing non-English (French) language.
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Verify the expectations when parsing a buffer contains an empty text field.
     *
     * @throws Exception
     */
    @Test
