...
public class RoamingConsortiumElementTest {
    ...
    /**
     * Verify that no exception will be thrown when parsing an empty buffer and resulting
    ...
    /**
     * Verify that ProtocolException will be thrown when parsing a buffer contain an OI length
