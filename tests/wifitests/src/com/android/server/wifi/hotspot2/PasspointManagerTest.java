...
public class PasspointManagerTest {
    ...
    /**
     * Verify the expectations for matchProvider when no providers are installed.
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Verify the expectations for matchProvider when ANQP entry doesn't exist in the cache.
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Verify the expectations for matchProvider when a HomeProvider is matched.
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Verify the expectations for matchProvider when a RoamingProvider is matched.
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Verify the expectations for matchProvider when there is no matching provider.
     *
     * @throws Exception
     */
    @Test
