...
public class PasspointManagerTest {
    ...
    private static final long PROVIDER_UID = 1L;
    ...
    public void addRemoveProviderWithValidUserCredential() throws Exception {
        ...
        when(mClock.getWallClockMillis()).thenReturn(PROVIDER_UID);
        when(mObjectFactory.makePasspointProvider(config, mWifiKeyStore, PROVIDER_UID))
                .thenReturn(provider);
    ...
    public void addProviderWithExistingConfig() throws Exception {
        ...
        when(mClock.getWallClockMillis()).thenReturn(PROVIDER_UID);
        when(mObjectFactory.makePasspointProvider(origConfig, mWifiKeyStore, PROVIDER_UID))
        ...
        when(mClock.getWallClockMillis()).thenReturn(PROVIDER_UID);
        when(mObjectFactory.makePasspointProvider(newConfig, mWifiKeyStore, PROVIDER_UID))
