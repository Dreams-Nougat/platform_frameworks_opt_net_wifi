...
public class PasspointManagerTest {
    ...
    public void anqpResponseSuccess() throws Exception {
        ...
        when(mAnqpRequestManager.onRequestCompleted(TEST_BSSID, true)).thenReturn(anqpKey);
    ...
    public void anqpResponseFailure() throws Exception {
        ...
        when(mAnqpRequestManager.onRequestCompleted(TEST_BSSID, false)).thenReturn(anqpKey);
