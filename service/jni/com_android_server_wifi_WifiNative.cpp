...
static jboolean android_net_wifi_startSupplicant(JNIEnv* env, jobject, jint ifaceType)
{
    return (::wifi_start_supplicant(ifaceType) == 0);
}

static jboolean android_net_wifi_killSupplicant(JNIEnv* env, jobject, jint ifaceType)
{
    return (::wifi_stop_supplicant(ifaceType) == 0);
}
...
static JNINativeMethod gWifiMethods[] = {
    ...
    { "startSupplicant", "(I)Z",  (void *)android_net_wifi_startSupplicant },
    { "killSupplicant", "(I)Z",  (void *)android_net_wifi_killSupplicant },
