    ...
    private class ModeStateMachine extends StateMachine {
        ...
        class ScanOnlyModeState extends State {
            ...
            public void enter() {
                ...
                mModeStateMachine.sendMessage(CMD_START_WIFI);
            }
            ...
            public boolean processMessage(Message message) {
                ...
                switch(message.what) {
                    case CMD_START_WIFI:
                        Log.d(TAG, "Transitioning to ScanOnlyModeActiveState");
        ...
        class ScanOnlyModeActiveState extends ModeActiveState {
            ...
            public boolean processMessage(Message message) {
                switch(message.what) {
                    case CMD_START_WIFI:
                        Log.d(TAG, "Received CMD_START_WIFI with ScanOnlyMode active.  drop");
                        break;
                    case CMD_START_WIFI_FAILURE:
