...
public class ExternalScoreEvaluator implements WifiNetworkSelector.NetworkEvaluator {
     ...
     */
    public void initialize(Context context, WifiConfigManager configManager,
    ...
    WifiConfiguration getExternalScoreCandidate(ExternalScoreTracker scoreTracker,
        ...
        switch (scoreTracker.getBestCandidateType()) {
            case ExternalScoreTracker.BestCandidateType.UNTRUSTED_NETWORK:
            ...
            case ExternalScoreTracker.BestCandidateType.SAVED_NETWORK:
            ...
            case ExternalScoreTracker.BestCandidateType.NONE:
    ...
    public WifiConfiguration evaluateNetworks(List<ScanDetail> scanDetails,
                    ...
                    boolean untrustedNetworkAllowed, WifiNetworkScoreCache scoreCache,
        ...
        for (ScanDetail scanDetail : scanDetails) {
            ...
            for (WifiConfiguration network : associatedConfigs) {
                ...
                // If the network is expected to use external scores, leave it to the
        ...
        WifiConfiguration candidate = getExternalScoreCandidate(externalScoreTracker, scoreCache);
    ...
    static class ExternalScoreTracker {
        ...
        private int mBestCandidateType = BestCandidateType.NONE;
