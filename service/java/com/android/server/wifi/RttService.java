...
public final class RttService extends SystemService {
    ...
    static class RttServiceImpl extends IRttManager.Stub {
        ...
        public void startService() {
            ...
            mStateMachine = new RttStateMachine(mLooper, mWifiInjector);
        ...
        class RttStateMachine extends StateMachine {
            ...
            RttStateMachine(Looper looper, WifiInjector wifiInjector) {
            ...
            class EnabledState extends State {
                ...
                public void enter() {
                    ...
                    // back to initial state and go all the cycles back to work.
                    // In this case RttService will receive WIFI_STATE_ENABLED when
                    // WifiStateMachine enters SupplicantStartedState.
                    // Then RttStateMachine enters EnabledStatewith, with the following
                    // code refreshing our wificond handler.
