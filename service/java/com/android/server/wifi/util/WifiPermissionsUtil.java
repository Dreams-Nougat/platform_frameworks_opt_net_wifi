...
public class WifiPermissionsUtil {
    ...
    public boolean canAccessScanResults(String pkgName, int uid,
        ...
        // Coarse Location permission to have access location information.
        ...
        // Either caller or app must enable location access, else return false
        if (!canCallingUidAccessLocation && !canAppPackageUseLocation) {
            return false;
        }
        // Check if Wifi Scan request is and operation allowed for this App
