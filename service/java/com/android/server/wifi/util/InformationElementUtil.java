...
public class InformationElementUtil {
    ...
    public static class Capabilities {
        ...
        public ArrayList<Integer> mKeyManagement;
        public ArrayList<Integer> mPairwiseCipher;
        public int mGroupCipher;
        public boolean mIsESS;
        public boolean mIsWEP;
        ...
        public void from(InformationElement[] ies, BitSet beaconCap) {
            ...
            if (mProtocol == ScanResult.PROTOCOL_NONE && mIsPrivacy) {
        ...
        public String generateCapabilitiesString() {
            String capabilities = "";
            if (mProtocol != ScanResult.PROTOCOL_NONE || mIsWEP) {
                capabilities += "[" + (mIsWEP ? "WEP" : protocolToString(mProtocol));
                for (int i = 0; i < mKeyManagement.size(); i++) {
                    capabilities += ((i == 0) ? "-" : "+")
                        + keyManagementToString(mKeyManagement.get(i));
                }
