        ...
        private void parseRsnElement(InformationElement ie) {
            ...
            try {
                ...
                for (int i = 0; i < akmCount; i++) {
                    ...
                    switch (akm) {
                        case WPA2_AKM_EAP:
                            keyManagement.add(new Integer(ScanResult.AKM_EAP));
                            break;
                        case WPA2_AKM_PSK:
                            keyManagement.add(new Integer(ScanResult.AKM_PSK));
                            break;
                        case WPA2_AKM_FT_EAP:
                            keyManagement.add(new Integer(ScanResult.AKM_FT_EAP));
                            break;
                        case WPA2_AKM_FT_PSK:
                            keyManagement.add(new Integer(ScanResult.AKM_FT_PSK));
                            break;
                        case WPA2_AKM_EAP_SHA256:
                            keyManagement.add(new Integer(ScanResult.AKM_EAP_SHA256));
                            break;
                        case WPA2_AKM_PSK_SHA256:
                            keyManagement.add(new Integer(ScanResult.AKM_PSK_SHA256));
                            break;
                        default:
                            // do nothing
                            break;
