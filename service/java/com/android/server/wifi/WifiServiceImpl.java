...
public class WifiServiceImpl extends IWifiManager.Stub {
    ...
    private class WifiStateMachineHandler extends WifiHandler {
        ...
        WifiStateMachineHandler(String tag, Looper looper) {
            super(tag, looper);
            mWsmChannel = new WifiAsyncChannel(TAG);
    ...
    public WifiServiceImpl(Context context) {
        ...
        mWifiStateMachineHandler =
                new WifiStateMachineHandler(TAG, wifiServiceHandlerThread.getLooper());
    ...
    public synchronized boolean setWifiEnabled(String packageName, boolean enable)
        ...
        mLog.trace("setWifiEnabled uid=").c(Binder.getCallingUid()).flush();
        /*
    ...
    public int getWifiEnabledState() {
        enforceAccessPermission();
        mLog.trace("getWifiEnabledStated uid=").c(Binder.getCallingUid()).flush();
    ...
    public void setWifiApEnabled(WifiConfiguration wifiConfig, boolean enabled) {
        enforceChangePermission();
        mLog.trace("setWifiApEnabled uid=").c(Binder.getCallingUid()).flush();
    ...
    public void requestActivityInfo(ResultReceiver result) {
        ...
        mLog.trace("requestedActivityInfo uid=").c(Binder.getCallingUid()).flush();
    ...
    public boolean enableNetwork(int netId, boolean disableOthers) {
        enforceChangePermission();
        mLog.trace("enableNetwork uid=").c(Binder.getCallingUid()).flush();
        if (mWifiStateMachineChannel != null) {
    ...
    public boolean addPasspointConfiguration(PasspointConfiguration config) {
        enforceChangePermission();
        mLog.trace("addPasspointConfiguration uid=").c(Binder.getCallingUid()).flush();
    ...
    public void enableTdls(String remoteAddress, boolean enable) {
        ...
        mLog.trace("enableTdls uid=").c(Binder.getCallingUid()).flush();
    ...
    public void enableTdlsWithMacAddress(String remoteMacAddress, boolean enable) {
        mLog.trace("enableTdlsWithMacAddress uid=").c(Binder.getCallingUid()).flush();
    ...
    public boolean acquireWifiLock(IBinder binder, int lockMode, String tag, WorkSource ws) {
        mLog.trace("acquireWifiLock uid=").c(Binder.getCallingUid()).flush();
    ...
    public void enableVerboseLogging(int verbose) {
        enforceAccessPermission();
        mLog.trace("enableVerboseLogging uid=").c(Binder.getCallingUid()).flush();
    ...
    public void enableAggressiveHandover(int enabled) {
        enforceAccessPermission();
        mLog.trace("enableAggressiveHandover uid=").c(Binder.getCallingUid()).flush();
    ...
    public void setAllowScansWithTraffic(int enabled) {
        enforceAccessPermission();
        mLog.trace("setAllowScansWithTraffic uid=").c(Binder.getCallingUid()).flush();
    ...
    public boolean setEnableAutoJoinWhenAssociated(boolean enabled) {
        enforceChangePermission();
        mLog.trace("setEnableAutoJoinWhenAssociated uid=").c(Binder.getCallingUid()).flush();
    ...
    public WifiConnectionStatistics getConnectionStatistics() {
        enforceAccessPermission();
        enforceReadCredentialPermission();
        mLog.trace("getConnectionStatistics").c(Binder.getCallingUid()).flush();
        if (mWifiStateMachineChannel != null) {
    ...
    public void enableWifiConnectivityManager(boolean enabled) {
        enforceConnectivityInternalPermission();
        mLog.trace("enableWifiConnectivityManager uid=").c(Binder.getCallingUid()).flush();
