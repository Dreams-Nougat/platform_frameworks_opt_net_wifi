...
public class WifiServiceImpl extends IWifiManager.Stub {
    ...
    public synchronized boolean setWifiEnabled(String packageName, boolean enable)
        ...
        // TODO b/33839553 will update to use enable directly as an argument to c()
        mLog.trace("setWifiEnabled uid=% enable=%")
                .c(Binder.getCallingUid())
                .c(enable ? "true" : "false").flush();
        /*
    ...
    public void setWifiApEnabled(WifiConfiguration wifiConfig, boolean enabled) {
        ...
        // TODO b/33839553 will update to use enable directly as an argument to c()
        mLog.trace("setWifiApEnabled uid=% enable=%")
                .c(Binder.getCallingUid())
                .c(enabled ? "true" : "false").flush();
    ...
    public boolean enableNetwork(int netId, boolean disableOthers) {
        ...
        mLog.trace("enableNetwork uid=% disableOthers=%")
                .c(Binder.getCallingUid())
                .c(disableOthers ? "true" : "false").flush();
