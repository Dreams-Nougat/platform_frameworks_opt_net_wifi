                    ...
                    if (targetWificonfiguration != null
                        ...
                        if (tm != null) {
                            ...
                            if (tm.getDefault().getPhoneCount() >= 2) {
                                ...
                                if (DBG) {
                                    log("simSlot: " + targetWificonfiguration.simSlot +
                                            ", subId: " + subId);
                                }
                                // If sim slot is unspecified, subId will be GET_SUBID_NULL_ERROR
