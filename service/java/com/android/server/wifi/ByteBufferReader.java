...
public class ByteBufferReader {
    @VisibleForTesting
    public static final int MINIMUM_INTEGER_SIZE = Byte.SIZE / 8;

    @VisibleForTesting
    public static final int MAXIMUM_INTEGER_SIZE = Long.SIZE / 8;
     ...
     * @throws NegativeArraySizeException
     */
    public static String readByteLengthAndString(ByteBuffer payload, Charset charset) {
