 ...
 * elements requests, passpoint icon requests, and remediation events.
 */
public class PasspointEventHandler {
     ...
     * TODO(zqiu): probably not needed once we remove the ANQP elements from the
     * ScanResult (when switching over to wificond).
     ...
     * @param success true if query is completed successfully, false otherwise
     */
    public void notifyIconDone(long bssid, IconEvent iconEvent) throws IOException {
