...
public class DomainMatcher {
    ...
    public DomainMatcher(String primaryDomain, List<String> secondaryDomains) {
        ...
        if (!TextUtils.isEmpty(primaryDomain)) {
            ...
            mRoot.addDomain(primaryLabel.iterator(), Match.Primary);
        }
    }

    /**
     * Check if domain is either a the same or a sub-domain of any of the domains in the
     * domain tree in this matcher, i.e. all or or a sub-set of the labels in domain matches
     * a path in the tree.
     *
