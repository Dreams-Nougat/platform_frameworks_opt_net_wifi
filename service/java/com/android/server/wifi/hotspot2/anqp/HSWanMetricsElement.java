...
public class HSWanMetricsElement extends ANQPElement {
    ...
    @VisibleForTesting
    public static final int LINK_STATUS_MASK = 0x3;

    @VisibleForTesting
    public static final int SYMMETRIC_LINK_MASK = 0x4;

    @VisibleForTesting
    public static final int AT_CAPACITY_MASK = 0x8;
    ...
    public String toString() {
        return String.format("HSWanMetrics{mStatus=%s, mSymmetric=%s, mCapped=%s, " +
                ...
                mDownlinkLoad * 100.0 / 256.0,
                mUplinkLoad * 100.0 / 256.0,
                mLMD);
    }
}
