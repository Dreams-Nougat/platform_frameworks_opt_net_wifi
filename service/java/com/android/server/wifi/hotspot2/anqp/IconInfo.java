...
public class IconInfo {
    ...
    public IconInfo(ByteBuffer payload) throws ProtocolException {
        ...
        mIconType = ByteBufferReader.readByteLengthAndString(payload, StandardCharsets.US_ASCII);
        mFileName = ByteBufferReader.readByteLengthAndString(payload, StandardCharsets.UTF_8);
    }
