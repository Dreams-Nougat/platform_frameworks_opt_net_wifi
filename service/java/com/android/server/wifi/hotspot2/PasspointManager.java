 ...
 */
public class PasspointManager implements PasspointEventHandler.Callbacks {
    private final Context mContext;
    private final PasspointEventHandler mHandler;

    public PasspointManager(Context context, WifiInjector wifiInjector) {
        mContext = context;
        mHandler = wifiInjector.makePasspointEventHandler(this);
    }

    /** Implementation of PasspointEventHandler.Callbacks. */
    @Override
